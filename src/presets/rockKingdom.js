...
const fields = [
  ...
  makeField({ key: 'hp', name: '生命', type: 'number', hidden: true }, 16),
  makeField({ key: 'patk', name: '物攻', type: 'number', hidden: true }, 17),
  makeField({ key: 'matk', name: '魔攻', type: 'number', hidden: true }, 18),
